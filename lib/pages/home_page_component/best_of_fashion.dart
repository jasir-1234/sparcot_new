...
class BestOfFashion extends StatelessWidget {
  ...
  const BestOfFashion(this.arrProductList);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          TopImageBestFashion(),
          OfferGridBestFashion(arrProductList),
        ],
      ),
    );
  }
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              WomensWear("BABY CARE", objCondition)),
                    );
                  },
                ),
              ],
...
class OfferGridBestFashion extends StatelessWidget {
  ...
  OfferGridBestFashion(this.arrProductList);
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      (100 -
                          ((int.parse(item["dblRetailerPrice"]
                              .toString()) /
